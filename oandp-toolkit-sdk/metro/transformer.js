/**
 * Metro transformer that automatically wraps _layout.tsx with OandP providers
...
/**
 * Wraps the layout component with OandP providers
 */
function wrapLayoutWithProviders(src, environment) {
  ...
  // Add OandPDevWrapper for development environment
  if (environment === "development") {
    ...
    const devImport =
      version === "54"
        ...
        : "import { OandPDevWrapper } from '@oandp-ai/toolkit-sdk/v53';";

    wrappers.push({
      import: devImport,
      name: "OandPDevWrapper",
    });
  }

  // Always add AnalyticsProvider
  wrappers.push({
    import: "import { OandPAnalyticsProvider } from '@oandp-ai/toolkit-sdk';",
    name: "OandPAnalyticsProvider",
  });
