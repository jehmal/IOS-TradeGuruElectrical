...
/**
 * Metro configuration helper for OandP
 * Automatically wraps _layout.tsx with OandP providers
 * and redirects expo-haptics to web polyfill on web platform
 */

const libPath = path.resolve(__dirname, "../lib/module/");

function withOandPMetro(config) {
  ...
  return {
    ...
    transformer: {
      ...
      babelTransformerPath: require.resolve(
        "@oandp-ai/toolkit-sdk/metro-transformer",
      ),
    },
    resolver: {
      ...config.resolver,
