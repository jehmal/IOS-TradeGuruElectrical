...
const IFRAME_ID = "oandp-web-preview";
const webTargetOrigins = ["http://localhost:3000", "https://oandpai.com", "https://oandp.ai"];
...
export class OandPErrorBoundary extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      hasError: false,
