...
export declare function createOandPTool<T extends z.ZodType>(tool: Tool<T>): Tool<T>;
type TextPart = {
    type: "text";
    text: string;
};
...
export declare function useOandPAgent<T extends Record<string, Tool<z.ZodType>>>(options: Omit<UseChatOptions<UIMessage>, "transport"> & {
    tools: T;
}): {
