...
8. **Swift 6 Strict Concurrency Compliance.** This project builds with Xcode 26 and Swift 6 strict concurrency. Every new or modified Swift file MUST comply with these rules before being considered complete:
